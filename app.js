...
// process.env.port || 3000; app.use(express.static('public'));
// app.set('views','src/views'); app.set('view engine','ejs'); app.get('/',
// function(req, res) {     res.render('index'); }) app.listen(port, function()
